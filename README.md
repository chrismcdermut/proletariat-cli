...
Now open separate terminal panes/tabs or IDE windows:

**Terminal Pane/Tab or IDE Window 1: Authentication specialist**
```bash
...
**Terminal Pane/Tab or IDE Window 2: API developer**
```bash
...
**Terminal Pane/Tab or IDE Window 3: Testing ground**
```bash
